...
Run /uc:autopilot to start autonomous execution.
```
...
**If "Skip for now":** End with "Run /uc:checkpoints when you're ready."
...
```
Checkpoint remains pending. Run /uc:checkpoints when ready.
```
...
{N} checkpoints remaining. Run /uc:checkpoints to continue.
